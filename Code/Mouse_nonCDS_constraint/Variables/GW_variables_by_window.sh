...
/well/lindgren/George/Data/Thesis_workflow/Results/Mouse_nonCDS_constraint/Variables/mmus_GRC38_constraint_var_by_window_1000_100_WMallSP_chr"$SGE_TASK_ID".csv.gz
