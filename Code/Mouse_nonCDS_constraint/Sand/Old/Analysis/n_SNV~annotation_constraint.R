...
# n_chr <- 19
# slide_size <- 50
alakazam <- function(cs, score, snv, n_chr){
...
n_chr <- 19
out_file <- "~/Dropbox/PhD/Data/NC_constraint/Figures_and_tables/Raw/Mouse_SNVs_by_annotation_percentile.csv"
