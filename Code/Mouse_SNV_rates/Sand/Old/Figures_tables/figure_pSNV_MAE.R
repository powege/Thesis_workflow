...
snv.file.AC <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/MAE_obs/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_AC.csv"
snv.file.CCG <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/MAE_obs/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_CCG.csv"
...
out_plot <- plot_grid(k1_A_mae_rel, 
                      k1_C_mae_rel, 
                      k1CG_nonCG_mae_rel,
                      k1CG_CG_mae_rel,
                      ncol = 2, nrow = 2)
