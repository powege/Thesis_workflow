...
k7_psnv_any$to <- "X"
k7_psnv <- rbind(k7_psnv[,c("k7_from", "to", "k7_mu_rate")], k7_psnv_any[,c("k7_from", "to", "k7_mu_rate")])

k7_psnv_any <- k7_psnv_any[,c("k7_from", "k7_from_N")]
colnames(k7_psnv_any) <- c("k7_from", "category_k7_N")
k7_psnv_any$category <- "Neutral"
ann_counts_all <- setDT(ann_counts_chr)[, .(category_k7_N = sum(k7_from_N)), by = .(k7_from, category)]
ann_counts <- rbind(ann_counts_all, k7_psnv_any)

unique(ann_counts$category)
ann_counts <- ann_counts[category == "Promoter"]
...
summary(lm(dt$k7_percentage[dt$mu_type == "A>X"] ~ dt$k7_mu_rate[dt$mu_type == "A>X"]))
summary(lm(dt$k7_percentage[dt$mu_type == "A>C"] ~ dt$k7_mu_rate[dt$mu_type == "A>C"]))
summary(lm(dt$k7_percentage[dt$mu_type == "A>G"] ~ dt$k7_mu_rate[dt$mu_type == "A>G"]))
summary(lm(dt$k7_percentage[dt$mu_type == "A>T"] ~ dt$k7_mu_rate[dt$mu_type == "A>T"]))

summary(lm(dt$k7_percentage[dt$mu_type == "C>X"] ~ dt$k7_mu_rate[dt$mu_type == "C>X"]))
summary(lm(dt$k7_percentage[dt$mu_type == "C>A"] ~ dt$k7_mu_rate[dt$mu_type == "C>A"]))
summary(lm(dt$k7_percentage[dt$mu_type == "C>G"] ~ dt$k7_mu_rate[dt$mu_type == "C>G"]))
summary(lm(dt$k7_percentage[dt$mu_type == "C>T"] ~ dt$k7_mu_rate[dt$mu_type == "C>T"]))

summary(lm(dt$k7_percentage[dt$mu_type == "CG>XG"] ~ dt$k7_mu_rate[dt$mu_type == "CG>XG"]))
summary(lm(dt$k7_percentage[dt$mu_type == "CG>AG"] ~ dt$k7_mu_rate[dt$mu_type == "CG>AG"]))
summary(lm(dt$k7_percentage[dt$mu_type == "CG>GG"] ~ dt$k7_mu_rate[dt$mu_type == "CG>GG"]))
summary(lm(dt$k7_percentage[dt$mu_type == "CG>TG"] ~ dt$k7_mu_rate[dt$mu_type == "CG>TG"]))



######

# plot(k7_psnv_any$k7_from_N, k7_psnv_any$k7_mu_rate)
# range(k7_psnv_any$k7_from_N)
# 
# psnv_A <- k7_psnv_any[which(stri_sub(k7_psnv_any$k7_from, 4, -4) == "A"),]
# psnv_ACG <- psnv_A[grep("CG", psnv_A$k7_from),]
# psnv_AnonCG <- psnv_A[-grep("CG", psnv_A$k7_from),]
# plot(psnv_A$k7_from_N, psnv_A$k7_mu_rate)
# plot(psnv_ACG$k7_from_N, psnv_ACG$k7_mu_rate)
# plot(psnv_AnonCG$k7_from_N, psnv_AnonCG$k7_mu_rate)
# summary(glm(psnv_AnonCG$k7_from_N ~ psnv_AnonCG$k7_mu_rate, family = "poisson"))
# 
# psnv_C <- k7_psnv_any[which(stri_sub(k7_psnv_any$k7_from, 4, -4) == "C"),]
# psnv_CCG <- psnv_C[grep("CG", psnv_C$k7_from),]
# psnv_CnonCG <- psnv_C[-grep("CG", psnv_C$k7_from),]
# plot(psnv_C$k7_from_N, psnv_C$k7_mu_rate)
# plot(psnv_CCG$k7_from_N, psnv_CCG$k7_mu_rate)
# plot(psnv_CnonCG$k7_from_N, psnv_CnonCG$k7_mu_rate)
# summary(glm(psnv_CnonCG$k7_from_N ~ psnv_CnonCG$k7_mu_rate, family = "poisson"))
...
ann_counts_chr <- fread("gunzip -cq ~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/counts_obs/m.mus_GRC38_k7_counts_by_annotation_and_chr.csv.gz")
# k7_psnv <- fread("gunzip -cq ~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/pSNV/WM_Harr_etal_2016_allSPECIES_k7_pSNV_specific.csv.gz")
k5_psnv <- fread("gunzip -cq ~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/pSNV/WM_Harr_etal_2016_allSPECIES_k5_pSNV_specific.csv.gz")

### FORMAT

k5_psnv_any <- setDT(k5_psnv)[, .(k5_to_N = sum(k5_to_N)), by = .(k5_from, k5_from_N)]
k5_psnv_any$k5_mu_rate <- k5_psnv_any$k5_to_N / k5_psnv_any$k5_from_N
k5_psnv_any$to <- "X"
k5_psnv <- rbind(k5_psnv[,c("k5_from", "to", "k5_mu_rate")], k5_psnv_any[,c("k5_from", "to", "k5_mu_rate")])

plot(k5_psnv_any$k5_from_N, k5_psnv_any$k5_mu_rate)
range(k5_psnv_any$k5_from_N)
psnv_A <- k5_psnv_any[which(stri_sub(k5_psnv_any$k5_from, 3, -3) == "A"),]
psnv_ACG <- psnv_A[grep("CG", psnv_A$k5_from),]
psnv_AnonCG <- psnv_A[-grep("CG", psnv_A$k5_from),]

plot(psnv_A$k5_from_N, psnv_A$k5_mu_rate)
plot(psnv_ACG$k5_from_N, psnv_ACG$k5_mu_rate)
plot(psnv_AnonCG$k5_from_N, psnv_AnonCG$k5_mu_rate)
summary(glm(psnv_AnonCG$k5_from_N ~ psnv_AnonCG$k5_mu_rate, family = "poisson"))
