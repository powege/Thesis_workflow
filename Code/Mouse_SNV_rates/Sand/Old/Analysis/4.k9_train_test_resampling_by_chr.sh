...
# /well/lindgren/George/Data/Thesis_workflow/Results/Mouse_SNV_rates/MAE_obs/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_AC.csv \
# /well/lindgren/George/Data/Thesis_workflow/Results/Mouse_SNV_rates/MAE_obs/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_CCG.csv 
