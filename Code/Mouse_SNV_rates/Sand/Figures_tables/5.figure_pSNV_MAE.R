...
# snv.file.AC <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_80_20_model_fit_specific_AC.csv"
# snv.file.CCG <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_80_20_model_fit_specific_CCG.csv"

# snv.file.AC <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_AC.csv"
# snv.file.CCG <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_CCG.csv"
# figure.AC.k1.rel <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/Figures_tables/figure_k9_AC_k1rel_MAE.jpg"
# figure.CCG.k1CG.rel <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/Figures_tables/figure_k9_CCG_k1CGrel_MAE.jpg"

# snv.file.AC <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_AC_k11_null.csv"
# snv.file.CCG <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_CCG_k11_null.csv"
# figure.AC.k1.rel <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/Figures_tables/figure_k9_AC_k1rel_MAE_k11_null.jpg"
# figure.CCG.k1CG.rel <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/Figures_tables/figure_k9_CCG_k1CGrel_MAE_k11_null.jpg"

# snv.file.AC <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_AC_k1CG_null.csv"
# snv.file.CCG <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/WM_Harr_etal_2016_allSPECIES_k9_resampling_by_chr_model_fit_specific_CCG_k1CG_null.csv"
# figure.AC.k1.rel <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/Figures_tables/figure_k9_AC_k1rel_MAE_k1CG_null.jpg"
# figure.CCG.k1CG.rel <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Mouse_SNV_rates/Figures_tables/figure_k9_CCG_k1CGrel_MAE_k1CG_null.jpg"
...
rm(tmp)
dt_CG$model <- factor(dt_CG$model, ordered = TRUE, levels = c("1-mer", "A-CG", "3-mer", "5-mer", "7-mer", "9-mer"))
dt_nonCG$model <- factor(dt_nonCG$model, ordered = TRUE, levels = c("1-mer", "A-CG", "3-mer", "5-mer", "7-mer", "9-mer"))
...
plot.mae.k1rel <- function(dt_A, title){
  ggplot(dt_A, aes(x=model, y=MAE_k1_rel, group=mutation, color=mutation)) + 
...
out_mae_CCG_rel <- plot_grid(k1CG_nonCG_mae_rel, k1CG_CG_mae_rel, ncol = 2, nrow = 1)
save_plot(figure.CCG.k1CG.rel,
          out_mae_CCG_rel,
          ncol = 1, nrow = 1,
          base_height = 5, base_width = 10)

k1_A_mae_rel <- plot.mae.k1rel(dt_A, "A")
k1_C_mae_rel <- plot.mae.k1rel(dt_C, "C")
out_mae_AC_rel <- plot_grid(k1_A_mae_rel, k1_C_mae_rel, ncol = 2, nrow = 1)
save_plot(figure.AC.k1.rel,
          out_mae_AC_rel,
          ncol = 1, nrow = 1,
          base_height = 5, base_width = 10)
