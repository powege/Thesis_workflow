...
k11_test$k1_from <- stri_sub(k11_test$k11_from, 6, -6) # extract middle base change
k11_train$k1_from <- stri_sub(k11_train$k11_from, 6, -6) # extract middle base change

## calculate pMU for train

k9_train <- k11_train # 7mer
...
k5_train <- k11_train # 5mer
colnames(k5_train) <- gsub("k11", "k5", colnames(k11_train)) # colnames
k5_train$k5_from <- stri_sub(k5_train$k5_from, 4, -4)
k5_train <- setDT(k5_train)[, .(k5_from_N = sum(k5_from_N), k5_to_N = sum(k5_to_N)), by = .(k5_from, to)] # sum across kmers

k3_train <- k11_train # 3mer
colnames(k3_train) <- gsub("k11", "k3", colnames(k11_train))
k3_train$k3_from <- stri_sub(k3_train$k3_from, 5, -5)
k3_train <- setDT(k3_train)[, .(k3_from_N = sum(k3_from_N), k3_to_N = sum(k3_to_N)), by = .(k3_from, to)] # sum across kmers

k1_train <- k11_train # 3mer
colnames(k1_train) <- gsub("k11", "k1", colnames(k11_train))
k1_train$k1_from <- stri_sub(k1_train$k1_from, 6, -6)
...
k11_train$k11_mu_rate <- k11_train$k11_to_N / k11_train$k11_from_N
...
k11_train$k11_mu_rate[k11_train$k11_from_N == 0] <- 0
...
k11_train$k9_from <- stri_sub(k11_train$k11_from, 2, -2)
k11_train$k7_from <- stri_sub(k11_train$k11_from, 3, -3)
k11_train$k5_from <- stri_sub(k11_train$k11_from, 4, -4)
k11_train$k3_from <- stri_sub(k11_train$k11_from, 5, -5)
k11_train$k1_from <- stri_sub(k11_train$k11_from, 6, -6)
k11_train <- k9_train[k11_train, on = c("k9_from", "to")]
k11_train <- k7_train[k11_train, on = c("k7_from", "to")]
k11_train <- k5_train[k11_train, on = c("k5_from", "to")]
k11_train <- k3_train[k11_train, on = c("k3_from", "to")]
k11_train <- k1_train[k11_train, on = c("k1_from", "to")]
k11_train <- k1CG_train[k11_train, on = c("k3_from", "to")]
rm(k1_train, k3_train, k5_train, k7_train, k1CG_train)

## calculate pmu for test
k11_test$k11_mu_rate <- k11_test$k11_to_N / k11_test$k11_from_N
k11_test$k11_mu_rate[k11_test$k11_from_N == 0] <- 0
k11_test$k1_from <- stri_sub(k11_test$k11_from, 6, -6)

## merge test and train
names(k11_test)[names(k11_test) == 'k11_mu_rate'] <- 'k11_mu_rate_obs'
k11_test <- k11_test[,c("k11_from", "to", "k11_mu_rate_obs")]
k11_train <- k11_train[,c("k11_from",
                        "k1_from",
                        "to",
                        "k1CG_mu_rate",
                        "k1_mu_rate",
                        ...
                        "k9_mu_rate",
                        "k11_mu_rate")]
k11_dt <- k11_test[k11_train, on = c("k11_from", "to")]
