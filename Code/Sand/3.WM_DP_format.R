### Script that identifies fraction of individuals with converage > 10X for each bp
...
out.file2 <- args[3]
CHR <- args[4]
n_individual <- as.numeric(args[5])
...
# calculate fraction
dt$fraction_10X <- (n_individual - dt$N)/n_individual
