...
# out.mouse.file <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Human_mouse_mapping/m.mus_GRC38_v101_whole_genome_features_multicell_overlap.matrix"
# out.human.file <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Human_mouse_mapping/h.sap_GRC38_v101_whole_genome_features_multicell_overlap.matrix"
