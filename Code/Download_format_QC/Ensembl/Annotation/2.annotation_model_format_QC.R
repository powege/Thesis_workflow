...
# reg.build.heart.gff <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Annotation/Raw/mus_musculus.GRCm38.heart_adult_8_weeks.Regulatory_Build.regulatory_activity.20180516.gff.gz"
# reg.build.kidney.gff <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Annotation/Raw/mus_musculus.GRCm38.kidney_adult_8_weeks.Regulatory_Build.regulatory_activity.20180516.gff.gz"
# reg.build.spleen.gff <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Annotation/Raw/mus_musculus.GRCm38.spleen_adult_8_weeks.Regulatory_Build.regulatory_activity.20180516.gff.gz"
# gencode.gtf <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Annotation/Raw/Mus_musculus.GRCm38.101.gtf.gz"
# N.mask.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Reference/Formatted/m.mus_GRCm38_dna_N.bed.gz"
# sm.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Reference/Formatted/m.mus_GRCm38_dna_sm.bed.gz"
# chr.nbp.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/Ensembl/Reference/Formatted/m.mus_GRCm38_dna_summary.bed"
# tad.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/TADs/Formatted/Mouse_TAD_boundries_liver_ESC_25kb_GRCm38.csv"
# out.file <- ""
# chr <- as.character(3)
