...
CHR="$SGE_TASK_ID"
OUT_BED_FILE=/well/lindgren/George/Data/Thesis_workflow/Data/Wild_mice_Harr_etal_2016/Coverage/Formatted/WM_all_sp_DP_less10X_more0.1_chr"$SGE_TASK_ID".bed.gz
