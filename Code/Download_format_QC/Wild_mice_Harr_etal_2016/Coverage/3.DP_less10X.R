...
# raw.path <- "/well/lindgren/George/Data/Thesis_workflow/Data/Wild_mice_Harr_etal_2016/Coverage/Raw/"
# prefix.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/Wild_mice_Harr_etal_2016/Coverage/Raw/domesticus_helgolandicus_bam.txt"
# functions_file <- "/well/lindgren/George/Code/Thesis_workflow/Code/Functions/FUNCTIONS.R"
# chr <- as.character(19)
# out.long.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/Wild_mice_Harr_etal_2016/Coverage/Raw/WM_domesticus_n_DP_less10X_chr19.csv.gz"
# out.bed.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/Wild_mice_Harr_etal_2016/Coverage/Formatted/WM_domesticus_DP_less10X_more0.1_chr19.bed"
...
fwrite(dt_more0.1, out.bed.file)
