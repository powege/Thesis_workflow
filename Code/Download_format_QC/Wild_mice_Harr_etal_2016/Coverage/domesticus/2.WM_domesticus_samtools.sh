...
STRAIN_PREFIX=`sed -n -e "$SGE_TASK_ID p" "$PED_ROOT"domesticus_helgolandicus_bam.txt`
# STRAIN_PREFIX=H12_sorted.cigar.nodups.realigned.recalibrated.sorted.bam
