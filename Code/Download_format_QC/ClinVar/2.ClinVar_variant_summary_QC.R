...
# raw.file <- "~/Dropbox/PhD/Data/Thesis_workflow/Data/ClinVar/Raw/variant_summary.txt.gz"
# qced.file <- "~/Dropbox/PhD/Data/Thesis_workflow/Data/ClinVar/Formatted/ClinVar_GRCh38_germline_pathogenic_benign_snps.vcf"
...
###
# x <- output[Chromosome == 11 & PositionVCF == 	61393965]
